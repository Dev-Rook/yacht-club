...
import VisitHeaderData from "../../Assets/Data/VisitHeader.json";

const VisitHeader = () => {
  const [data, setData] = useState(VisitHeaderData);

  return (
    <div className={Styles.Section}>
      <div className={Styles.Content_Container}>
        <p className={Styles.Large_Text}>The Club Awaits You!</p>
      </div>
